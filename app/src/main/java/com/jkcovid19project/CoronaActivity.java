...
import com.jkcovid19project.Adapter.CoronaAdapter;
import com.jkcovid19project.Adapter.FAQAdapter;
import com.jkcovid19project.Models.Corona;
import com.jkcovid19project.Models.FAQ;
import com.jkcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Jammu and Kashmir").getJSONObject("districtData");
