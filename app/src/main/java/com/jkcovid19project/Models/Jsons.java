package com.jkcovid19project.Models;

public class Jsons {

    String home_treatment_images, home_treatment_links, toll_numbers, lab_test, donate,
            tweets, faq, epass, tracker, corona, jk, cbse, vocational_education, go;

    public Jsons() {
    }

    public Jsons(String home_treatment_images, String home_treatment_links, String toll_numbers, String lab_test, String donate, String tweets, String faq, String epass, String tracker, String corona, String jk, String cbse, String vocational_education, String go) {
